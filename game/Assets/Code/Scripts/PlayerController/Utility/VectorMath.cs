...
namespace UnityUtils {
    public class VectorMath {
        ...
        public static Vector3 GetAngularVelocity(Quaternion rotation, Quaternion lastRotation, float deltaTime) {
            
            return 2f/deltaTime * new Vector3(
                rotation.x * lastRotation.y - rotation.y * lastRotation.x - rotation.z * lastRotation.w + rotation.w * lastRotation.z,
                rotation.x * lastRotation.z + rotation.y * lastRotation.w - rotation.z * lastRotation.x - rotation.w * lastRotation.y,
                rotation.x * lastRotation.w - rotation.y * lastRotation.z + rotation.z * lastRotation.y - rotation.w * lastRotation.x
            );
        }
